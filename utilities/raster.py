...
class Raster:
    ...
    def readRasterGDAL(self, fn, pdf = False):
        ...
        print('done reading took %.2f s' % time.time()-t0)
    ...
    def printInfo(self):
        ...
        print('xllcorner %d' % self.xllcorner)
        print('yllcorner %d' % self.yllcorner)
        print('cellsize %d' % self.cellsize)
        print('nodatavalue %d' % self.nodatavalue)
